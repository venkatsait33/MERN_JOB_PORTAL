...
const PostForm = ({ submitHandler, input, handleDescriptionChange, changeEventHandler, companies, handleSelectHandler, loading, name, button }) => {
        ...
        <div className='p-4 border border-gray-300 rounded-lg '>
            <form onSubmit={submitHandler}
                ...
                <div className='flex items-center justify-between gap-4 max-sm:flex-col '>
                    <label htmlFor="" className="block mb-2 text-lg font-medium text-center max-sm:text-base">Title</label>
                ...
                <div className='flex items-center justify-between gap-4 max-sm:flex-col '>
                    <label htmlFor="" className="block mb-2 text-lg font-medium text-center max-sm:text-base">Requirements</label>
                ...
                <div className='flex flex-col gap-3'>
                    <p className="block mb-2 text-lg font-medium text-center max-sm:text-base">Job Role</p>
                    <div className='flex items-center justify-between gap-4 max-sm:flex-col '>
                        <label className="block mb-2 text-lg font-medium max-sm:text-base">Department</label>
                    ...
                    <div className='flex items-center justify-between gap-4 max-sm:flex-col '>
                        <label className="block mb-2 text-lg font-medium max-sm:text-base">Category</label>
                    ...
                    <div className='flex items-center justify-between gap-4 max-sm:flex-col '>
                        <label className="block mb-2 text-lg font-medium max-sm:text-base">Locations</label>
                        <select
                            className="select select-bordered"
                            name="location"
                    ...
                    <div className='flex items-center justify-between gap-4 max-sm:flex-col '>
                        <label className="block mb-2 text-lg font-medium max-sm:text-base">Employment Type</label>
                        <select
                            className="select select-bordered"
                            name="jobType"
                            value={input.jobType}
                    ...
                    <div className='flex items-center justify-between gap-4 max-sm:flex-col '>
                        <label className="block mb-2 text-lg font-medium max-sm:text-base">Job-Shifts</label>
                        <select
                            className="select select-bordered"
                            name="jobShifts"
                ...
                <div className='flex flex-col gap-3'>
                    <p className="block mb-2 text-lg font-medium text-center max-sm:text-base">Job Requirements</p>
                    <div className='flex items-center justify-between gap-4 max-sm:flex-col '>
                        <label htmlFor="" className="block mb-2 text-lg font-medium text-center max-sm:text-base">Year of Experience</label>
                        <input type="number" value={input.experience} className=' input input-bordered' name='experience' onChange={changeEventHandler} />
                    </div>
                    <div className='flex items-center justify-between gap-4 max-sm:flex-col '>
                        <label htmlFor="" className="block mb-2 text-lg font-medium text-center max-sm:text-base">Education</label>
                        <input type="text" value={input.education} className=' input input-bordered' name='education' onChange={changeEventHandler} />
                    </div>
                    <div className='flex items-center justify-between gap-4 max-sm:flex-col '>
                        <label className="block mb-2 text-lg font-medium max-sm:text-base">English Level</label>
                        <select
                            className="select select-bordered"
                            name="englishLevel"
                    ...
                    <div className='flex items-center justify-between gap-4 max-sm:flex-col '>
                        <label className="block mb-2 text-lg font-medium max-sm:text-base">Gender</label>
                        <select
                            className="select select-bordered"
                            name="gender"
                            value={input.gender}
                ...
                <div className='flex items-center justify-between gap-4 max-sm:flex-col '>
                    <label htmlFor="" className="block mb-2 text-lg font-medium text-center max-sm:text-base">Salary</label>
                    <input type="text" value={input.salary} className=' input input-bordered' name='salary' onChange={changeEventHandler} />
                </div>
                <div className='flex items-center justify-between gap-4 max-sm:flex-col '>
                    <label htmlFor="" className="block mb-2 text-lg font-medium text-center max-sm:text-base">No of Position</label>
                    <input type="number" value={input.positions} className=' input input-bordered' name='positions' onChange={changeEventHandler} />
                </div>
                <div className='flex items-center justify-between gap-4 max-sm:flex-col '>
                    <label htmlFor="" className="block mb-2 text-lg font-medium text-center max-sm:text-base">Company</label>
                    {
                ...
                <div>
                    <p className="block mb-2 text-lg font-medium text-center max-sm:text-base">Job Description</p>
