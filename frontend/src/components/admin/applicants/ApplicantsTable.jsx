...
const ApplicantsTable = ({ fetchAllApplicants }) => {
  ...
  return (
    <div>
      <div className="md:h-[60vh] overflow-y-scroll max-w-screen p-2 no-scrollbar">
        <h1 className="mt-2 mb-2 text-center ">
          Candidates Applied for {applicants?.title}
        </h1>
        <div className="overflow-x-auto shadow-xl border no-scrollbar md:h-[50vh] rounded-box border-base-content/5 bg-base-100">
