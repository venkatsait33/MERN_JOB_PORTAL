    ...
    <>
      <div className=" md:h-[210px] max-sm:h-[270px] ">
        <div className="flex flex-col mt-10 ml-10 ">
          <div className="flex items-center max-sm:flex-col sm:gap-4 md:gap-8">
            <div>
          ...
          <div className="flex max-sm:flex-col items-center gap-4 font-semibold">
            <p className="flex items-center gap-1">
              <FaCopyright /> 2025 | All rights reserved
            </p>
