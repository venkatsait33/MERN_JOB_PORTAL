...
const HomeCoverSection = () => {
  ...
  return (
    <div className="">
      <div className="flex flex-col gap-5 p-4 mt-20 md:ml-10">
        <h4 className=" text-[#1F8268] md:text-2xl">
          INDIA'S #1 FREELANCER PLATFORM
        </h4>
        <TypingText />
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="btn md:btn-xl bg-[#1F8268]"
          >
            Search for jobs
          </button>
        </div>
        <div>
          ...
          <div className="flex gap-2">
            <img
              ...
              alt=""
              className="w-[135px] h-[40px] bg-white p-1"
            />
            <img
              src="https://cdn.apna.co/apna-learn/Support%20Icons/aicte-seeklogo.png"
              alt=""
              className="w-[40px] h-[40px] bg-white p-1"
            />
            <img
