...
import NetworkMessage from "./NetworkMessage.jsx";
    ...
    const sendVerificationOtp = async () => {
        try {
            const res = await axios.post(
                `${USER_API_END_POINT}/send-verification-otp`,
                {},
                {
                    withCredentials: true,
                }
                    ...
                    <ul className="px-1 menu menu-horizontal">
                        {user && user.role === "recruiter" ? (
                            <>
                                ...
                                <li>
                                    <Link to="/recruiter/jobs" className="text-lg font-semibold">
                                        Jobs
                                    </Link>
                                </li>
                            </>
                        ...
                        {user ? (
                            <div className="flex items-center gap-3">
                                {user && user.role === "candidate" && (
                                    <Link to="/job-history" className="font-semibold md:text-lg">
                                        Job History
                                    </Link>
                                )}
                            ...
                            <div>
                                <div className="flex items-center gap-4 p-2">
                                    <div>
                                        <button
                                            className="font-semibold hover:cursor-pointer  text-[#1F8268]"
                                            onClick={() =>
                                    ...
                                    <div>
                                        <button
                                            className="btn max-sm:btn-sm bg-[#1F8268] hover:bg-white hover:border-[#1F8268] hover:text-[#1F8268]"
                                            onClick={() =>
